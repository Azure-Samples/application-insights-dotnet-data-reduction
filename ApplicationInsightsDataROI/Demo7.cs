    ...
    internal class Demo7
    {
        public static async Task RunAsync(CancellationToken token)
        {
            ...
            configuration.TelemetryProcessorChainBuilder
                ...
                // apply aggressive sampling for dependency telemetry that is faster than 100 ms
                .Use((next) => { return new DependencyFilteringWithAggressiveSampling(next, configuration); })
